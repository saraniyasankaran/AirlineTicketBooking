...
public class ServletUpdate extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String update = "UPDATE flight set flight_name='"+name+"',from_city='"+fromcity+"',to_city='"+tocity+"',date='"+date+"',time='"+time+"',airport_name='"+airname+"',ticket_price='"+ticket+"',description='"+description+"' where flight_no='"+num+"'";
